...
public class CoberturaProfundidad extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CoberturaProfundidad
     */
    static Grafo grafo;
    
    public CoberturaProfundidad(Grafo grafo) {
        this.grafo = grafo;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cobertura por Profundidad");
        ...
        getContentPane().add(AtrasBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 260, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CoberturaProfundidad(grafo).setVisible(true);
            }
        });
    }
